...
public class AttrUtils {
    ...
    public static int getDimensionFromAttr(AttrSet attrs, String name, int defaultValue) {
        ...
        try {
            ...
            HiLog.error(HILOG_LABEL, "exception in getDimensionFromAttr with int defaultValue");
        }
        return value;
    }
    ...
    public static int getDimensionFromAttr(AttrSet attrs, String name, float defaultValue) {
        ...
        try {
            ...
            HiLog.error(HILOG_LABEL, "exception in getDimensionFromAttr with float defaultValue");
        }
        return (int) value;
    }
    ...
    public static String getStringFromAttr(AttrSet attrs, String name, String defaultValue) {
        ...
        try {
            ...
            HiLog.error(HILOG_LABEL, "exception in getStringFromAttr with default value");
        }
        return value;
    }
    ...
    /**
     * Function to get Element from attribute.
     *
     * @param attrs Attribute set
     * @param name String name
     * @return Element
